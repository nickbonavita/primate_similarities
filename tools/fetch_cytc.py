#!/usr/bin/env python3
"""Fetch nuclear cytochrome c (CYCS) CDS sequences for all primates in this project.

Cytochrome c is one of the most highly conserved proteins in eukaryote evolution.
The 1967 Fitch & Margoliash analysis of cytochrome c sequences was the first
molecular phylogenetic study, making it an iconic marker in evolutionary biology.
"""
...
GENES = {
    "cytc": {
        "label": "nuclear cytochrome c (CYCS) coding sequence",
        "aliases": (
            "gene=CYCS",
            "gene=cycs",
        ...
        "terms": (
            "CYCS[Gene] AND mRNA",
            "cytochrome c, somatic[Title] AND mRNA",
            "CYCS[Gene] AND complete cds",
            "somatic cytochrome c[Title] AND mRNA",
            "cytochrome c somatic[Title]",
            "CYCS[Gene]",
            "cytochrome c[Title] AND somatic[Title]",
        ),
        "min_len": 200,
    },
}
